...
$(document).ready(function(){
    setInterval(function(){
        if(scrap.chat){
            $.get("/my-chats", function(data){
                ...
                for(var i = 0; i < data.length; i++){
                    if(data[i].inverted) {
                        html += "<b><a href='/public-profile?uuid="+data[i].adminUuid+"'><i class='icon-user''></i></a> <a class='chat-user-switch' data-uuid='"+data[i].adminUuid+"' href='#'>"+data[i].adminName +"</a></b> <small style='color:silver'>" + data[i].created +"</small></br>";
                        html += data[i].text+"<br/>";
                    } else {
                        html += "<b><a href='/public-profile?uuid="+data[i].userUuid+"'><i class='icon-user''></i></a> <a class='chat-user-switch' data-uuid='"+data[i].userUuid+"' href='#'>"+data[i].name +"</a></b> <small style='color:silver'>" + data[i].created +"</small></br>";
                        html += data[i].text+"<br/>";
                    }
                }
    ...
    $("#themes_panel").on("click", ".chat-user-switch", function(){
        console.log("clk");
